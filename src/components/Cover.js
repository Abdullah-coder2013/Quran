...
const Cover = (props) => {
    ...
    return (
        <div className="cover bg-green-900 p-5 rounded-xl shadow-lg flex justify-center flex-col h-3/4 border-4 border-green-950">
            ...
            <br/>
            <h5 className="text-center text-xl text-yellow-500 border-slate-900 ntext">Website made by Abdullah</h5><br/>
            <h5 className="text-center text-xl text-yellow-700 ntext">Text from Quran.com API</h5>
